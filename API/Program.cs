...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Azure2", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Azure2Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Azure2 API v1");
